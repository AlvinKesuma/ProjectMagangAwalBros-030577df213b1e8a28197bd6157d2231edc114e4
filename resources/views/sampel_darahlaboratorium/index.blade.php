...
@section('title')
Data Kepatuhan pelaksanaan identifikasi pasien sebelum pengambilan sampel darah laboratorium
@endsection
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('sampel-darahlaboratorium.destroy', $item->id) }}" method="POST" class="d-inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Kepatuhan pelaksanaan identifikasi pasien sebelum pengambilan sampel darah laboratorium</h5>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('sampel-darahlaboratorium.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Kepatuhan pelaksanaan identifikasi pasien sebelum pengambilan sampel darah laboratorium";
    ...
    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('sampel-darahlaboratorium') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Kepatuhan pelaksanaan identifikasi pasien sebelum pengambilan sampel darah laboratorium";
