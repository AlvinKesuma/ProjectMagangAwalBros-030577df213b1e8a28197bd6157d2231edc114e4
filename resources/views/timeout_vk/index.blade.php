...
@section('title')
Data Kepatuhan Tim Melaksanakan Proses Time Out di VK
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Kepatuhan Tim Melaksanakan Proses Time Out di VK </h4>
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('timeout-vk.destroy', $item->id) }}" method="POST" class="d-inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Kepatuhan Tim Melaksanakan Proses Time Out di VK</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="col">
                            ...
                            <input type="number" step="0.1" id="tahun" name="tahun" class="form-control" placeholder="Masukkan nilai tahun 2023" required>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('timeout-vk.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Kepatuhan Tim Melaksanakan Proses Time Out di VK";
        document.getElementById('unit').value = "VK";
    }

    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('timeout-vk') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Kepatuhan Tim Melaksanakan Proses Time Out di VK";
