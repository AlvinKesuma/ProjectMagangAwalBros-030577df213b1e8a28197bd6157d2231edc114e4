...
@section('title')
Data Kepatuhan pelaksanaan identifikasi pasien saat pemberian obat
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Kepatuhan pelaksanaan identifikasi pasien saat pemberian obat </h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Kepatuhan pelaksanaan identifikasi pasien saat pemberian obat</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="col">
                            ...
                            <input type="number" step="0.1" id="tahun_2023" name="tahun_2023" class="form-control" placeholder="Tahun 2023" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="col">
                            <label for="tahun_2024" class="form-label">Tahun 2024</label>
                            <input type="number" id="tahun_2024" name="tahun_2024" class="form-control" placeholder="Tahun 2024" readonly>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('identifikasi-pemberianobat.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Kepatuhan pelaksanaan identifikasi pasien saat pemberian obat";
    ...
    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('identifikasi-pemberianobat') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Kepatuhan pelaksanaan identifikasi pasien saat pemberian obat";
