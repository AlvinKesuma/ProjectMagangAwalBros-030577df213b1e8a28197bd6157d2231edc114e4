...
@section('title')
Data Kepatuhan Pelabelan Obat High Alert pada Sediaan Obat yang akan Diberikan ke Pasien Rawat Inap
@endsection
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('pelabelan-obatpasien.destroy', $item->id) }}" method="POST" class="d-inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Kepatuhan Pelabelan Obat High Alert pada Sediaan Obat yang akan Diberikan ke Pasien Rawat Inap</h5>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('pelabelan-obatpasien.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Kepatuhan Pelabelan Obat High Alert pada Sediaan Obat yang akan Diberikan ke Pasien Rawat Inap";
    ...
    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('pelabelan-obatpasien') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Kepatuhan Pelabelan Obat High Alert pada Sediaan Obat yang akan Diberikan ke Pasien Rawat Inap";
