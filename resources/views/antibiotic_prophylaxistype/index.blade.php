...
@section('title')
Data Ketepatan Pemberian Jenis Antibiotik Profilaksis
@endsection
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <h4>Data Ketepatan Pemberian Jenis Antibiotik Profilaksis</h4>
                        ...
                        @forelse ($data as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('antibiotic-prophylaxistype.destroy', $item->id) }}" method="POST" class="d-inline-block delete-form">
                                        @csrf
                                        @method('DELETE')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Form Data Ketepatan Pemberian Jenis Antibiotik Profilaksis</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="col">
                            ...
                            <input type="year" step="0.1" id="tahun" name="tahun" class="form-control" placeholder="Masukkan tahun" required>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function openCreateModal() {
        ...
        document.getElementById('formModal').action = "{{ route('antibiotic-prophylaxistype.store') }}";
        document.getElementById('formModal').querySelector('[name="_method"]').value = "POST";
        document.getElementById('exampleModalLabel1').innerText = "Tambah Data Ketepatan Pemberian Jenis Antibiotik Profilaksis";
        document.getElementById('unit').value = "UGD";
    }

    function openEditModal(data) {
        document.getElementById('formModal').reset();
        document.getElementById('formModal').action = "{{ url('antibiotic-prophylaxistype') }}/" + data.id;
        document.getElementById('formModal').querySelector('[name="_method"]').value = "PUT";
        document.getElementById('exampleModalLabel1').innerText = "Edit Data Ketepatan Pemberian Jenis Antibiotik Profilaksis";
